...
DATABASES = {
    'default': dj_database_url.config(default='postgresql://vaultspace_user:Dto5mHtFX19MuvV45KpQGL6qp7L9G2vR@dpg-csecacdsvqrc73f0fnrg-a.oregon-postgres.render.com:5432/vaultspace',conn_max_age=600    )
}
