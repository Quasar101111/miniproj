...
# Add warehouse_recommender to Python path
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '0.0.0.0','competent-jerrie-vaultspace-05c51baa.koyeb.app','miniproj-p8xq.onrender.com']
...
# Update the RECOMMENDER_API_URL to use environment variable
RECOMMENDER_API_URL = os.getenv('FASTAPI_URL', 'http://app.recommender.localhost:8001')
